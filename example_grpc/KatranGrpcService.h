...
class KatranGrpcService final : public KatranService::Service {
 public:
  ...
  Status changeMac(ServerContext* context, const Mac* request, Bool* response)
      override;

  Status getMac(ServerContext* context, const Empty* request, Mac* response)
      override;

  Status addVip(ServerContext* context, const VipMeta* request, Bool* response)
      override;

  Status delVip(ServerContext* context, const Vip* request, Bool* response)
      override;
  ...
  Status modifyVip(
      ServerContext* context,
      const VipMeta* request,
      Bool* response) override;

  Status modifyReal(
      ServerContext* context,
      const RealMeta* request,
      Bool* response) override;
