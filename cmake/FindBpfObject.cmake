...
search/processing for the associated component:
  ...
  ``BPFOBJECT_EXTRA_DEFINES``
    Extra defines to pass to clang while building bpf object
...
macro(bpf_object name input)
  ...
  add_custom_command(OUTPUT ${BPF_SKEL_FILE}
    COMMAND bash -c "${BPFOBJECT_BPFTOOL_EXE} gen skeleton ${BPF_O_FILE} name ${name} > ${BPF_SKEL_FILE}"
    VERBATIM
    DEPENDS ${BPF_O_FILE}
